        ...
        <div className="register-container">
            <div className="content">
                <section>
                    ...
                    <h1>Cadastro</h1>
                    <p>Faça seu cadastro, entre na plataforma e ajude pessoas as encontrar os casos da sua ONG.</p>
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="className input-group">
                        <input type="text" value={city} onChange={e => seCity(e.target.value)} placeholder="Cidade" />
